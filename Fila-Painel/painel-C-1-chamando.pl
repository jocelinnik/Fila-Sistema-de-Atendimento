...
sub setup_widgets {
  ...
  $lblsenha->modify_font(
    Gtk2::Pango::FontDescription->from_string("Courier Bold 72") );
  $lblsenha->modify_fg( $lblsenha->state,
    Gtk2::Gdk::Color->parse("#FF0000") );
  $lblultima->modify_font(
    Gtk2::Pango::FontDescription->from_string("Courier Bold 72") );
  $lblultima->modify_fg( $lblultima->state,
    Gtk2::Gdk::Color->parse("#333333") );
...
#$label_time->modify_font(Gtk2::Pango::FontDescription->from_string("Tahoma 36")); $label_time->modify_fg($label_time->state, Gtk2::Gdk::Color->parse("i#195b37"));
  $label_news->modify_font(
    Gtk2::Pango::FontDescription->from_string("Tahoma 46") );
  $label_news->modify_fg( $label_news->state,
    Gtk2::Gdk::Color->parse("#195B37") );
