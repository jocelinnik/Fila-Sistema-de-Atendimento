...
my $red   = Gtk2::Gdk::Color->new( 255 x 255, 0,     0 );
my $font_courier =
    Gtk2::Pango::FontDescription->from_string('Courier New Bold 80');
my $font_arial = Gtk2::Pango::FontDescription->from_string('Arial 50');
my ( @arraytotal, @ultima, @ultima_s, @exp, @senhas, @mesa, @ultima_p,
  @ultima_n );
my $senhas;
my %arraytotal;
my $mesa;
my ( $posicao, $tamanho, $ultima_p, $ultima_n, $ultima_s, $tela, $telaultima,
  $num );
