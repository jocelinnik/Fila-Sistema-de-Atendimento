...
my ( $window, $fixed1, $titulo, $lblsenha, $ultima, $lblultima ) =
    map { $gladexml->get_widget($_) }
    qw(window1 fixed1 label1 label2 label3 label4);
