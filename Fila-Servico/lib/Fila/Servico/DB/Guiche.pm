...
__PACKAGE__->add_columns(
  ...
  identificador     => { data_type => 'char(10)', },
  jid_opiniometro   => { data_type => 'varchar', },
  pular_opiniometro => { data_type => 'integer', },
  timeout_chamando  => {
    data_type     => 'integer',
    default_value => 180,
  },
...
__PACKAGE__->has_many(
  'categorias',
  'Fila::Servico::DB::GuicheCategoria',
...
__PACKAGE__->has_many(
  'atendimentos',
  'Fila::Servico::DB::GuicheAtendimento',
  { 'foreign.id_guiche' => 'self.id_guiche' },
  { 'join_type'         => 'left' }
);
...
__PACKAGE__->has_many(
  'encaminhamentos',
  'Fila::Servico::DB::GuicheEncaminhamento',
  { 'foreign.id_guiche' => 'self.id_guiche' },
  { 'join_type'         => 'left', 'order_by' => 'vt_ini' }
);

__PACKAGE__->has_many(
  'encaminhamentos_atuais',
  'Fila::Servico::DB::GuicheEncaminhamento',
  {
    'foreign.id_guiche' => 'self.id_guiche',
    'foreign.vt_ini'    => \"<= NOW()",        #"
