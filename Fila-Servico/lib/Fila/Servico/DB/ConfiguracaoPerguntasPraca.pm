...
ConfiguracaoPerguntasPraca - Define a ordem das perguntas no opiniometro geral

=head1 DESCRIPTION

Esta tabela mantém um registro temporal da informação da configuração
do opiniometro geral, listando quais são as cinco perguntas a serem
respondidas.
